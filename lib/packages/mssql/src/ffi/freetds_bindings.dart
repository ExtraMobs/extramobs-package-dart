...
typedef _dbopenC = Pointer<DBPROCESS> Function(
  Pointer<LOGINREC>,
  Pointer<Utf8>,
);
typedef _dbopenDart = Pointer<DBPROCESS> Function(
  Pointer<LOGINREC>,
  Pointer<Utf8>,
);

typedef _tdsdbopenC = Pointer<DBPROCESS> Function(
  Pointer<LOGINREC>,
  Pointer<Utf8>,
  Int32,
);
typedef _tdsdbopenDart = Pointer<DBPROCESS> Function(
  Pointer<LOGINREC>,
  Pointer<Utf8>,
  int,
);
...
typedef _dbsetoptC = Int32 Function(
  Pointer<DBPROCESS>,
  Int32,
  Pointer<Utf8>,
  Int32,
);
typedef _dbsetoptDart = int Function(
  Pointer<DBPROCESS>,
  int,
  Pointer<Utf8>,
  int,
...
typedef _errHandlerSigC = Int32 Function(
  Pointer<DBPROCESS>,
  Int32 /*severity*/,
  Int32 /*dberr*/,
  Int32 /*oserr*/,
...
typedef _dberrhandleC = Pointer<NativeFunction<_errHandlerSigC>> Function(
  Pointer<NativeFunction<_errHandlerSigC>>,
);
typedef _dberrhandleDart = Pointer<NativeFunction<_errHandlerSigC>> Function(
  Pointer<NativeFunction<_errHandlerSigC>>,
);

/// C: MHANDLEFUNC dbmsghandle(MHANDLEFUNC handler)
typedef _msgHandlerSigC = Int32 Function(
  Pointer<DBPROCESS>,
  Int32 /*msgno*/,
  Int32 /*msgstate*/,
  Int32 /*severity*/,
...
typedef _dbmsghandleC = Pointer<NativeFunction<_msgHandlerSigC>> Function(
  Pointer<NativeFunction<_msgHandlerSigC>>,
);
typedef _dbmsghandleDart = Pointer<NativeFunction<_msgHandlerSigC>> Function(
  Pointer<NativeFunction<_msgHandlerSigC>>,
);

typedef _wrapperInitC = Int32 Function(
  Pointer<NativeFunction<_errHandlerSigC>>,
  Pointer<NativeFunction<_msgHandlerSigC>>,
);
typedef _wrapperInitDart = int Function(
  Pointer<NativeFunction<_errHandlerSigC>>,
  Pointer<NativeFunction<_msgHandlerSigC>>,
);
...
typedef _bcp_initC = Int32 Function(
  Pointer<DBPROCESS>,
  Pointer<Utf8>,
  Pointer<Utf8>,
  Pointer<Utf8>,
...
typedef _bcp_initDart = int Function(
  Pointer<DBPROCESS>,
  Pointer<Utf8>,
  Pointer<Utf8>,
  Pointer<Utf8>,
...
typedef _bcp_bindDart = int Function(
  Pointer<DBPROCESS>,
  Pointer<Uint8>,
  int,
  int,
...
typedef _bcp_colptrC = Int32 Function(
  Pointer<DBPROCESS>,
  Pointer<Uint8>,
  Int32,
);
