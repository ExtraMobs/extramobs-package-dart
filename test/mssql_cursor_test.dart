...
void main() {
  ...
  test('positional markers ignore quoted text, identifiers and nested comments', () async {
    await open();
    const sql =
    ...
    expect(
      ByteData.sublistView(Uint8List.fromList(native.params[3].bytes))
  ...
  test('executemany consumes parameter generators incrementally and resets rowcount', () async {
    await open();
    var generated = 0;
  ...
  test('multiple idle cursors coexist; fully fetched results release native ownership', () async {
    await open();
