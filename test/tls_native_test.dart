    ...
    () {
      ...
      if (env['MSSQL_TLS_FIXTURE'] != null) {
        if (env['MSSQL_TLS_CONFIG_CHILD'] == '1') {
          test('omitted policy preserves native configuration; explicit policy overrides it', () async {
            await expectLater(
              connect('plain', null),
      ...
      test('captures the exact certificate, including login-only TLS, in both APIs', () async {
      ...
      test('native configuration is preserved or overridden as requested', () async {
