...
int sql_server_wrapper_peer_certificate(DBPROCESS *dbproc, unsigned char *buffer, int capacity);
void dbexit(void);
...
#define DBSETCAFILE              20001 /* sql_server_wrapper: explicit CA trust, empty disables validation */
